...
public class OpenCVActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2, View.OnTouchListener {
    ...
    public OpenCVActivity() {
        Log.w(TAG, "Instantiated new " + this.getClass());
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        Log.w(TAG, "Touch image coordinates: (" + x + ", " + y + ")");
        ...
        Log.w(TAG, "Touched rgba color: (" + mBlobColorRgba.val[0] + ", " + mBlobColorRgba.val[1] +
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (mIsColorSelected) {
            ...
            Log.w(TAG, "Contours count: " + contours.size());
