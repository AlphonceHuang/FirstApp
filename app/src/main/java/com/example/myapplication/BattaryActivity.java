    ...
    private final BroadcastReceiver mBattery = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)){
                ...
                int battery_temp = intent.getIntExtra(BatteryManager.EXTRA_TEMPERATURE, 0);
                ...
                int battery_status = intent.getIntExtra(BatteryManager.EXTRA_STATUS, BatteryManager.BATTERY_STATUS_UNKNOWN);
                ...
                int battery_health = intent.getIntExtra(BatteryManager.EXTRA_STATUS, BatteryManager.BATTERY_HEALTH_UNKNOWN);
